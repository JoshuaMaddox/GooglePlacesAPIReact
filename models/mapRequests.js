const fs = require('fs'),
      ...
      googleMapsClient = require('@google/maps').createClient({key: process.env.API_KEY}),
      tablename = 'maps';
...
exports.sendSearch = function(searchStr, cb) {
  console.log('I am the new searchStr', searchStr)
  let url = `https://maps.googleapis.com/maps/api/place/textsearch/json?query=${searchStr}&key=${process.env.API_KEY}`
  console.log('url', url)
  axios.get(url)
    .then((res) => {
...
// exports.getTimeZone = function(markerWithId, cb) {
//   console.log('I am markerWithId!!!!!!!!!', markerWithId)
//   let timeStamp = getTime()
//   console.log("timeStamp", timeStamp)
//   let url = `https://maps.googleapis.com/maps/api/timezone/json?location=${markerWithId.lat},${markerWithId.lng}&timestamp=${timeStamp}`
//   console.log('I am url!!! ', url)
//   axios.get(url)
//     .then((res) => {
//       console.log('I am res.data in mapRequests models: ', res.data)
//       cb(null, res)
//     })
//     .catch((err) => {
//       cb(err)
